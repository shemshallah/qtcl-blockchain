...
web: gunicorn --workers 2 --worker-class gthread --threads 4 --worker-tmp-dir /dev/shm --timeout 120 --graceful-timeout 30 --keep-alive 5 --max-requests 1000 --max-requests-jitter 100 --access-logfile - --error-logfile - --log-level info -b 0.0.0.0:${PORT:-5000} wsgi_config:application
