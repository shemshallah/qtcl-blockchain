...
# ── Server Mechanics ─────────────────────────────────────────
daemon = False
preload_app = True  # True for streamable HTTP: all workers share one engine/session singleton.
                    # Set False ONLY when using stdio transport (subprocess-per-client model).
